...
# Remove variable that suppresses Electron GUI (set by Claude Code / other Electron hosts)
...
$proc.StartInfo = $psi
Write-Host "Starting DnD Virtual Tabletop..." -ForegroundColor Cyan
$proc.Start() | Out-Null
